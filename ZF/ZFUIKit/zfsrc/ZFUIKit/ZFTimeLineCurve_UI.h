 ...
 */
zfclass ZFLIB_ZFUIKit ZFTimeLineCurveEaseIn : zfextend ZFTimeLineCurve {
 ...
 * @brief ease in time line, see #ZFTimeLineCurve
 */
zfclass ZFLIB_ZFUIKit ZFTimeLineCurveEaseOut : zfextend ZFTimeLineCurve {
 ...
 * @brief ease in time line, see #ZFTimeLineCurve
 */
zfclass ZFLIB_ZFUIKit ZFTimeLineCurveEaseInOut : zfextend ZFTimeLineCurve {
 ...
 * @brief ease in time line, see #ZFTimeLineCurve
 */
zfclass ZFLIB_ZFUIKit ZFTimeLineCurveBounceIn : zfextend ZFTimeLineCurve {
 ...
 * @brief ease in time line, see #ZFTimeLineCurve
 */
zfclass ZFLIB_ZFUIKit ZFTimeLineCurveBounceOut : zfextend ZFTimeLineCurve {
 ...
 * @brief ease in time line, see #ZFTimeLineCurve
 */
zfclass ZFLIB_ZFUIKit ZFTimeLineCurveBounceInOut : zfextend ZFTimeLineCurve {
