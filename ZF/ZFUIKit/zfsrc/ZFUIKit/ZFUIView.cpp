...
ZFEVENT_REGISTER(ZFUIView, ViewChildOnChange)
...
ZFEVENT_REGISTER(ZFUIView, UIScaleOnChange)
ZFEVENT_REGISTER(ZFUIView, ViewFocusOnChange)
...
// ============================================================
// parent
void ZFUIView::_ZFP_ZFUIView_parentChanged(
