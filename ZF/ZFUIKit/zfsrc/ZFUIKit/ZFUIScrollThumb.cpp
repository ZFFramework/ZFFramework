...
void ZFUIScrollThumb::scrollThumbPosFromViewPos(
    ...
    if(scrollContentOffset > 0) { // bounce at head
        pos = 0;
        size = scrollViewSize - scrollContentOffset;
    }
    else if(scrollViewSize >= scrollContentSize && scrollContentOffset < 0) { // bounce at tail
        pos = -scrollContentOffset;
        size = scrollViewSize - pos;
    }
    else if(scrollContentOffset + fixedContentSize < scrollViewSize) { // bounce at tail
        pos = -scrollContentOffset;
...
void ZFUIScrollThumb::scrollThumbPosToViewPos(
