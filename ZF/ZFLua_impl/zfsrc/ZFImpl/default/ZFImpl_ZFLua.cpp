...
zfbool ZFImpl_ZFLua_toStringT(
    ...
    if(lua_isnumber(L, luaStackOffset)) {
        lua_Number n = lua_tonumber(L, luaStackOffset);
        zfdoubleToStringT(s, (zft_zfdouble)n);
        return zftrue;
    }
    if(lua_isstring(L, luaStackOffset)) {
    ...
    return ZFImpl_ZFLua_toStringT(s, param, allowEmpty, holderCls);
}
zfbool ZFImpl_ZFLua_toStringT(
        ZF_IN_OUT zfstring &s
        , ZF_IN ZFObject *obj
...
zfbool ZFImpl_ZFLua_toLuaValue(
    ...
    zfstring s;
    if(ZFImpl_ZFLua_toStringT(s, obj, allowEmpty)) {
        lua_pushstring(L, s);
        return zftrue;
    }
...
static zfstring _ZFP_ZFImpl_ZFLua_zfstringAppend_string(
    ...
    else if(ZFImpl_ZFLua_toStringT(ret, L, i)) {
        // nothing to do
    }
    else if(toString) {
        ZFImpl_ZFLua_luaObjectInfoT(ret, L, i);
...
zfbool ZFImpl_ZFLua_zfstringAppend(
    ...
    zfstring fmt;
    if(!ZFImpl_ZFLua_toStringT(fmt, L, luaParamOffset)) {
        return zffalse;
    }
