...
// ============================================================
/** @brief see #ZFImpl_ZFLua_luaState */
extern ZF_ENV_EXPORT void ZFImpl_ZFLua_implSetupScope(ZF_IN_OUT ZFCoreArray<lua_State *> const &luaStateList,
 ...
 */
zfclass ZF_ENV_EXPORT ZFImpl_ZFLuaValue : zfextends ZFObject
{
