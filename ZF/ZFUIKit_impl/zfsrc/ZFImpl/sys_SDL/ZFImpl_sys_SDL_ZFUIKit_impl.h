...
inline void ZFImpl_sys_SDL_ZFUIPointFromSDL_PointT(ZF_OUT ZFUIPoint &ret, ZF_IN const SDL_Point &sdlPoint)
{
...
inline void ZFImpl_sys_SDL_ZFUIPointToSDL_FPointT(ZF_OUT SDL_FPoint &ret, ZF_IN const ZFUIPoint &point)
{
    ret.x = (float)point.x;
    ret.y = (float)point.y;
}
...
inline void ZFImpl_sys_SDL_ZFUIPointFromSDL_FPointT(ZF_OUT ZFUIPoint &ret, ZF_IN const SDL_FPoint &sdlPoint)
{
    ret.x = (zffloat)sdlPoint.x;
    ret.y = (zffloat)sdlPoint.y;
}
...
inline void ZFImpl_sys_SDL_ZFUIRectToSDL_RectT(ZF_OUT SDL_Rect &ret, ZF_IN const ZFUIRect &rect)
{
    ret.x = (int)rect.x;
    ret.y = (int)rect.y;
...
inline void ZFImpl_sys_SDL_ZFUIRectFromSDL_RectT(ZF_OUT ZFUIRect &ret, ZF_IN const SDL_Rect &sdlRect)
{
...
inline void ZFImpl_sys_SDL_ZFUIRectToSDL_FRectT(ZF_OUT SDL_FRect &ret, ZF_IN const ZFUIRect &rect)
{
    ret.x = (float)rect.x;
    ret.y = (float)rect.y;
...
inline void ZFImpl_sys_SDL_ZFUIRectFromSDL_FRectT(ZF_OUT ZFUIRect &ret, ZF_IN const SDL_FRect &sdlRect)
{
    ret.x = (zffloat)sdlRect.x;
    ret.y = (zffloat)sdlRect.y;
    ret.width = (zffloat)sdlRect.w;
...
inline void ZFImpl_sys_SDL_ZFUIColorToSDL_ColorT(ZF_IN SDL_Color &ret, ZF_IN const ZFUIColor &color)
{
...
inline void ZFImpl_sys_SDL_ZFUIColorFromSDL_ColorT(ZF_OUT ZFUIColor &ret, ZF_IN const SDL_Color sdlColor)
{
    ret = ZFUIColorMake(
