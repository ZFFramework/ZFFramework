...
// ============================================================
zfclassNotPOD _ZFP_ZFUIScrollViewImpl_sys_SDL_ScrollView : zfextendsNotPOD ZFImpl_sys_SDL_View, zfextendsNotPOD ZFUIScrollViewImplHelperProtocol
{
public:
...
public:
    ...
    static zfbool _ZFP_contains(ZF_IN const SDL_Rect &rect, ZF_IN zffloat x, ZF_IN zffloat y)
    {
        return x >= rect.x && x <= rect.x + rect.w
            && y >= rect.y && y <= rect.y + rect.h;
    }
    ZFImpl_sys_SDL_View *_ZFP_findChildRecursive(ZF_IN ZFImpl_sys_SDL_View *parent, ZF_IN zffloat x, ZF_IN zffloat y, ZF_IN zfbool findScrollView)
    {
    ...
    ZFImpl_sys_SDL_View *_ZFP_findChild(ZF_IN_OUT zfindex &beforeIndex, ZF_IN zffloat x, ZF_IN zffloat y)
    {
        --beforeIndex;
    ...
    virtual ZFUIScrollViewImplHelper *findTouchedChildScrollView(ZF_IN zffloat x, ZF_IN zffloat y)
    {
        ...
        do {
            ...
            if(t != zfnull)
            {
                ...
                {
                    return &(((_ZFP_ZFUIScrollViewImpl_sys_SDL_ScrollView *)innerChild)->_ZFP_scrollViewImplHelper);
                }
            }
    ...
    static zfbool _ZFP_childOffset(ZF_OUT int &xOffset,
                                   ZF_OUT int &yOffset,
...
private:
    static zfbool sdlMouseGrabCallback(ZF_IN ZFImpl_sys_SDL_View *owner,
                                       ...
                                       ZF_IN zfint x, ZF_IN zfint y)
    {
        ...
        ZFUIMouseActionEnum mouseAction = ZFUIMouseAction::e_MouseDown;
...
public:
    ...
    {
        zfdelete((_ZFP_ZFUIScrollViewImpl_sys_SDL_ScrollView *)nativeScrollView);
    }
