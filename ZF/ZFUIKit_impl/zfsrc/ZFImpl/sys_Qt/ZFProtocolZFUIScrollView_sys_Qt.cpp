...
static QGraphicsSceneMouseEvent *_ZFP_ZFUIScrollViewImpl_sys_Qt_MouseEventClone(
...
static zfbool _ZFP_ZFUIScrollViewImpl_sys_Qt_ChildOffset(
        ZF_OUT zffloat &xOffset
...
public:
    ...
    virtual void mouseEventForward(
        ...
        QGraphicsWidget *v = (QGraphicsWidget *)nativeChild;
        QGraphicsSceneMouseEvent *e = (QGraphicsSceneMouseEvent *)nativeMouseEvent;
    ...
    zfbool _ZFP_isSubclass(
            ZF_IN const QMetaObject *cls0
            , ZF_IN const QMetaObject *cls1
            ) {
    ...
    QGraphicsWidget *_ZFP_findFgView(
            ZF_IN zffloat x
            , ZF_IN zffloat y
            ) {
        ...
        for(zfindex i = fgViews.count() - 1; i != zfindexMax(); --i) {
            QGraphicsWidget *t = (QGraphicsWidget *)fgViews[i]->nativeView();
    ...
    QGraphicsWidget *_ZFP_findChildRecursive(
            ZF_IN QGraphicsWidget *parent
            , ZF_IN zffloat x
            , ZF_IN zffloat y
    ...
    QGraphicsWidget *_ZFP_findChild(
    ...
    virtual void *translateFromParentToChild(
        ...
        zffloat xOffset = 0;
        zffloat yOffset = 0;
        _ZFP_ZFUIScrollViewImpl_sys_Qt_ChildOffset(xOffset, yOffset, this, (QGraphicsWidget *)nativeChild);
