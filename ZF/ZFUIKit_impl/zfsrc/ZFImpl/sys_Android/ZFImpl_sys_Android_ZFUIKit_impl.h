...
extern ZFLIB_ZFUIKit_impl jclass ZFImpl_sys_Android_jclassZFAndroidPoint(void);
extern ZFLIB_ZFUIKit_impl jobject ZFImpl_sys_Android_ZFUIPointToZFAndroidPoint(ZF_IN const ZFUIPoint &point, ZF_IN_OUT jobject jobjPoint);
// note returned value must be released by DeleteLocalRef
// note conversion may have performance issue
extern ZFLIB_ZFUIKit_impl jobject ZFImpl_sys_Android_ZFUIPointToZFAndroidPoint(ZF_IN const ZFUIPoint &point);
extern ZFLIB_ZFUIKit_impl void ZFImpl_sys_Android_ZFUIPointFromZFAndroidPointT(ZF_OUT ZFUIPoint &ret, ZF_IN jobject jobjPoint);
...
extern ZFLIB_ZFUIKit_impl jclass ZFImpl_sys_Android_jclassZFAndroidSize(void);
extern ZFLIB_ZFUIKit_impl jobject ZFImpl_sys_Android_ZFUISizeToZFAndroidSize(ZF_IN const ZFUISize &size, ZF_IN_OUT jobject jobjSize);
// note returned value must be released by DeleteLocalRef
// note conversion may have performance issue
extern ZFLIB_ZFUIKit_impl jobject ZFImpl_sys_Android_ZFUISizeToZFAndroidSize(ZF_IN const ZFUISize &size);
extern ZFLIB_ZFUIKit_impl void ZFImpl_sys_Android_ZFUISizeFromZFAndroidSizeT(ZF_OUT ZFUISize &ret, ZF_IN jobject jobjSize);
...
extern ZFLIB_ZFUIKit_impl jclass ZFImpl_sys_Android_jclassZFAndroidMargin(void);
extern ZFLIB_ZFUIKit_impl jobject ZFImpl_sys_Android_ZFUIMarginToZFAndroidMargin(ZF_IN const ZFUIMargin &margin, ZF_IN_OUT jobject jobjMargin);
// note returned value must be released by DeleteLocalRef
// note conversion may have performance issue
extern ZFLIB_ZFUIKit_impl jobject ZFImpl_sys_Android_ZFUIMarginToZFAndroidMargin(ZF_IN const ZFUIMargin &margin);
extern ZFLIB_ZFUIKit_impl void ZFImpl_sys_Android_ZFUIMarginFromZFAndroidMarginT(ZF_OUT ZFUIMargin &ret, ZF_IN jobject jobjMargin);
...
extern ZFLIB_ZFUIKit_impl jclass ZFImpl_sys_Android_jclassZFAndroidRect(void);
extern ZFLIB_ZFUIKit_impl jobject ZFImpl_sys_Android_ZFUIRectToZFAndroidRect(ZF_IN const ZFUIRect &rect, ZF_IN_OUT jobject jobjRect);
// note returned value must be released by DeleteLocalRef
// note conversion may have performance issue
extern ZFLIB_ZFUIKit_impl jobject ZFImpl_sys_Android_ZFUIRectToZFAndroidRect(ZF_IN const ZFUIRect &rect);
extern ZFLIB_ZFUIKit_impl void ZFImpl_sys_Android_ZFUIRectFromZFAndroidRectT(ZF_OUT ZFUIRect &ret, ZF_IN jobject jobjRect);
...
// ============================================================
// Color
extern ZFLIB_ZFUIKit_impl jint ZFImpl_sys_Android_ZFUIColorToColor(ZF_IN const ZFUIColor &color);
extern ZFLIB_ZFUIKit_impl void ZFImpl_sys_Android_ZFUIColorFromColorT(ZF_OUT ZFUIColor &ret, ZF_IN jint jColor);
...
extern ZFLIB_ZFUIKit_impl void ZFImpl_sys_Android_viewTreePrintT(ZF_OUT zfstring &ret, ZF_IN jobject nativeView);
