 ...
 *   according #ZFUIOnScreenKeyboardState
 */
zfclass ZFLIB_ZFUIWidget ZFUIOnScreenKeyboardAutoFitLayout : zfextend ZFUIScrollView {
...
public:
     ...
     */
    ZFPROPERTY_ASSIGN(zfbool, autoFitEnable, zftrue)
     ...
     */
    ZFPROPERTY_ASSIGN(zfbool, autoFitFocusedViewToVisible, zftrue)
     ...
     */
    ZFPROPERTY_ASSIGN(zfbool, autoFitScrollEnable, zftrue)
