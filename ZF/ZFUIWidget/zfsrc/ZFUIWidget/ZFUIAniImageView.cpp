...
ZFMETHOD_DEFINE_0(ZFUIAniImageData, ZFCoreArray<zftimet> const &, frameDurations) {
...
zfbool ZFUIAniImageData::serializableOnSerializeFromData(
...
zfbool ZFUIAniImageData::serializableOnSerializeToData(
...
public:
    static void onTimer(
            ...
            , ZF_IN ZFUIAniImageView *pimplOwner
            ) {
...
void ZFUIAniImageView::layoutOnMeasure(
        ZF_OUT ZFUISize &ret
