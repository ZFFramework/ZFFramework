...
// ============================================================
zfclassNotPOD _ZFP_ZFIO_http_FindData {
public:
...
zfbool _ZFP_ZFIO_http_FindNext(ZF_IN_OUT ZFIOFindData &fd);
zfbool _ZFP_ZFIO_http_FindFirst(
