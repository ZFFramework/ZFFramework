...
public class ZFEnum {
    public static int raw(String rawEnumValueName) {
        return native_rawEnumValue(null, rawEnumValueName);
    }
    ...
    public static int rawAssert(String rawEnumValueName) {
        int ret = native_rawEnumValue(null, rawEnumValueName);
        if (ret == -1) {
            native_enumInvalid(null, rawEnumValueName);
        }
        return ret;
    }
