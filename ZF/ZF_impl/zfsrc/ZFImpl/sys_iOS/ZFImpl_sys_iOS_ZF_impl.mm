...
zfiterator ZFImpl_sys_iOS_NSDictionaryIterFind(ZF_IN NSDictionary *dict,
                                               ZF_IN id key)
{
    _ZFP_ZFImpl_sys_iOS_NSDictionaryIterData *impl = [_ZFP_ZFImpl_sys_iOS_NSDictionaryIterData new];
    impl.allKeys = dict.allKeys;
...
zfbool ZFImpl_sys_iOS_NSDictionaryIterValid(ZF_IN NSDictionary *dict,
...
void ZFImpl_sys_iOS_NSDictionaryIterNext(ZF_IN NSDictionary *dict,
                                         ZF_IN_OUT zfiterator &it)
{
    _ZFP_ZFImpl_sys_iOS_NSDictionaryIterData *impl = (__bridge _ZFP_ZFImpl_sys_iOS_NSDictionaryIterData *)it.data();
    impl.index += 1;
}
id ZFImpl_sys_iOS_NSDictionaryIterKey(ZF_IN NSDictionary *dict,
                                      ZF_IN const zfiterator &it)
{
    _ZFP_ZFImpl_sys_iOS_NSDictionaryIterData *impl = (__bridge _ZFP_ZFImpl_sys_iOS_NSDictionaryIterData *)it.data();
    return [impl.allKeys objectAtIndex:impl.index];
}
id ZFImpl_sys_iOS_NSDictionaryIterValue(ZF_IN NSDictionary *dict,
                                        ZF_IN const zfiterator &it)
{
    _ZFP_ZFImpl_sys_iOS_NSDictionaryIterData *impl = (__bridge _ZFP_ZFImpl_sys_iOS_NSDictionaryIterData *)it.data();
...
void ZFImpl_sys_iOS_NSDictionaryIterValue(ZF_IN NSDictionary *dict,
                                          ZF_IN_OUT zfiterator &it,
                                          ZF_IN id value)
{
...
void ZFImpl_sys_iOS_NSDictionaryIterRemove(ZF_IN NSDictionary *dict,
                                           ZF_IN_OUT zfiterator &it)
{
    if(![dict isKindOfClass:[NSMutableDictionary class]])
    {
