...
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_FUNC_1(v_zfstring, zfbool, isEqual
        , ZFMP_IN(const zfstring &, ref)
        )
...
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_FUNC_2(v_zfstring, void, zfunsafe_bufferGiveUp
        , ZFMP_OUT(void *&, ret)
        , ZFMP_OUT(zfindex &, length)
        )
