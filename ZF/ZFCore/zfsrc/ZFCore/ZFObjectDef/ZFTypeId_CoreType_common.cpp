...
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_FUNC_4(v_ZFBuffer, void, bufferChange, ZFMP_IN(void *, buffer), ZFMP_IN(zfindex, bufferCapacity), ZFMP_IN(zfindex, bufferSize), ZFMP_IN(zfbool, bufferAutoFree))
