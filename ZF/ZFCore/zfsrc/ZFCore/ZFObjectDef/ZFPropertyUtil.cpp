...
ZFMETHOD_FUNC_USER_REGISTER_FOR_FUNC_4(void, ZFPropertyCopyAll
        , ZFMP_IN(ZFObject *, dstObj)
        , ZFMP_IN(ZFObject *, srcObj)
...
ZFMETHOD_FUNC_USER_REGISTER_FOR_FUNC_3(void, ZFPropertyGetInfo
        ...
        , ZFMP_IN(const ZFProperty *, propertyInfo)
        , ZFMP_IN(ZFObject *, ownerObject)
        )
ZFMETHOD_FUNC_USER_REGISTER_FOR_FUNC_2(zfstring, ZFPropertyGetInfo
        , ZFMP_IN(const ZFProperty *, propertyInfo)
        , ZFMP_IN(ZFObject *, ownerObject)
        )
