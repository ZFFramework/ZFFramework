...
// ============================================================
typedef zfstlhashmap<ZFSigName, zfstlvector<const ZFMethod *> > _ZFP_ZFMethodFuncNameMapType;
typedef zfstlhashmap<ZFSigName, _ZFP_ZFMethodFuncNameMapType> _ZFP_ZFMethodFuncMapType;
