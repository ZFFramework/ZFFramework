...
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_FUNC_1(v_ZFClass, ZFObject *, classTag
        , ZFMP_IN(const zfchar *, key)
        )
...
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_FUNC_1(v_ZFClass, zfautoObject, classTagRemoveAndGet
        , ZFMP_IN(const zfchar *, key)
        )
