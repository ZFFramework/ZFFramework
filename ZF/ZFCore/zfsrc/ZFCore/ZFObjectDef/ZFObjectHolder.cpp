...
void ZFObjectHolder::objectInfoImplAppend(ZF_IN_OUT zfstring &ret) {
...
zfidentity ZFObjectHolder::objectHashImpl(void) {
    return ZFObjectHash(this->_ZFP_objectHolded);
}
ZFCompareResult ZFObjectHolder::objectCompareImpl(ZF_IN ZFObject *anotherObj) {
