...
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_FUNC_1(v_ZFFilterForZFObject, ZFObject *, filterElementAt
        , ZFMP_IN(zfindex, index)
        )
...
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_FUNC_1(v_ZFPropertyDynamicRegisterParam, void, propertyInitValueCallback
        , ZFMP_IN(ZFPropertyDynamicRegisterInitValueCallback, propertyInitValueCallback)
        )
...
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_FUNC_1(v_ZFSerializableData, ZFObject *, serializableDataTag
        , ZFMP_IN(const zfchar *, key)
        )
...
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_FUNC_1(v_ZFSerializableData, zfautoObject, serializableDataTagRemoveAndGet
        , ZFMP_IN(const zfchar *, key)
        )
