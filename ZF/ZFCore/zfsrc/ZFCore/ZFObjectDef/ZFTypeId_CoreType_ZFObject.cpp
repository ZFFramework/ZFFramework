...
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_FUNC_1(v_ZFMethodDynamicRegisterParam, zfstring, paramNameFixedAt
        , ZFMP_IN(zfindex, index)
        )
...
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_FUNC_1(v_ZFMP, zfstring, paramNameFixedAt
        , ZFMP_IN(zfindex, index)
        )
