...
public:
    ...
    zfiter iterAdd(
        ...
        _Iter *impl = zfpoolNew(_Iter);
        zfstlpair<typename zfimplhashmap<T_Key, T_Value, T_Hash, T_Equal>::iterator, bool> insertResult = this->insert(zfstlpair<T_Key, T_Value>(key, value));
    ...
    zfbool iterAccess(
            ZF_OUT typename zfimplhashmap<T_Key, T_Value, T_Hash, T_Equal>::iterator &it
            , ZF_IN T_Key const &key
