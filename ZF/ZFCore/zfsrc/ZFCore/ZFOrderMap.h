...
#ifndef _ZFI_ZFOrderMap_h_
#define _ZFI_ZFOrderMap_h_

#include "ZFKeyValueContainer.h"

ZF_NAMESPACE_GLOBAL_BEGIN

zfclassFwd _ZFP_ZFOrderMapPrivate;
/**
 * @brief container of ZFObject, see #ZFKeyValueContainer
 */
zfclass ZFLIB_ZFCore ZFOrderMap: zfextend ZFKeyValueContainer {
    ZFOBJECT_DECLARE(ZFOrderMap, ZFKeyValueContainer)
...
private:
    _ZFP_ZFOrderMapPrivate *d;
};

ZF_NAMESPACE_GLOBAL_END
#endif // #ifndef _ZFI_ZFOrderMap_h_
