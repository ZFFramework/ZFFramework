...
// ============================================================
zfbool _ZFP_ZFImpl_ZFRes_resPathFix(ZF_IN const zfstring &resRootPath, ZF_IN_OUT zfstring &result, ZF_IN const zfstring &original)
{
...
zfbool ZFPROTOCOL_INTERFACE_CLASS(ZFRes)::resSeek(ZF_IN void *token,
                                                  ZF_IN zfindex byteSize,
                                                  ZF_IN_OPT ZFSeekPos position /* = ZFSeekPosBegin */)
{
    return ZFFileSeek(token, byteSize, position);
}
zfindex ZFPROTOCOL_INTERFACE_CLASS(ZFRes)::resRead(ZF_IN void *token,
                                                   ZF_IN void *buf,
...
// ============================================================
// res find
zfbool ZFPROTOCOL_INTERFACE_CLASS(ZFRes)::resFindFirst(ZF_IN_OUT ZFFileFindData::Impl &fd,
