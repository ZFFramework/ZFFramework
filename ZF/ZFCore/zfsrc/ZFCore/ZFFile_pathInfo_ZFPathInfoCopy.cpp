...
// ============================================================
static void _ZFP_ZFPathInfoCopy_SetErrPos(ZF_IN ZFPathInfo *errPos, ZF_IN const ZFPathInfo *s)
{
    if(errPos != zfnull)
    {
...
static zfbool _ZFP_ZFPathInfoCopy_copyFile(ZF_IN const ZFPathInfo &srcPath,
...
static zfbool _ZFP_ZFPathInfoCopy_copyDir(ZF_IN const ZFPathInfo &srcPath,
                                          ZF_IN const ZFPathInfo &dstPath,
                                          ZF_IN zfbool isForce,
                                          ZF_IN_OPT ZFPathInfo *errPos)
{
