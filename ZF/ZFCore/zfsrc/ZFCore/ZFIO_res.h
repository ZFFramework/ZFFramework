...
#ifndef _ZFI_ZFIO_res_h_
#define _ZFI_ZFIO_res_h_
...
ZFMETHOD_FUNC_INLINE_DECLARE_1(ZFLIB_ZFCore, ZFInput, ZFInputForRes
    ...
    ZFInput ret;
    ZFInputForPathInfoT(ret, ZFPathInfo(ZFPathType_res(), resFilePath));
    return ret;
}
 ...
 * such as #ZFResOpen, #ZFResFindFirst\n
