...
function(zfprojConfigBefore_ZFFramework_test projName srcfiles)
    if(COMMAND zfprojConfigBefore_ZF_impl)
        zfprojConfigBefore_ZF_impl(${projName} ${srcfiles})
    endif()
endfunction(zfprojConfigBefore_ZFFramework_test)
...
endfunction(zfprojConfigAfter_ZFFramework_test)
