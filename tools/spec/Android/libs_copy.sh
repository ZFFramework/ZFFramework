...
sh "$ZF_ROOT_PATH/tools/common/copy_file_in_tree.sh" "lib${PROJ_NAME}.so" "$PROJ_PATH/zflib/build/intermediates/library_and_local_jars_jni/release/jni" "$ZF_ROOT_PATH/_release/Android/module/$PROJ_NAME/src/main/jniLibs" >/dev/null 2>&1
sh "$ZF_ROOT_PATH/tools/common/copy_file_in_tree.sh" "lib${PROJ_NAME}.so" "$PROJ_PATH/zflib/build/intermediates/library_and_local_jars_jni/release/copyReleaseJniLibsProjectAndLocalJars/jni" "$ZF_ROOT_PATH/_release/Android/module/$PROJ_NAME/src/main/jniLibs" >/dev/null 2>&1
